...
pub fn adicionar_coluna_de_credito_presumido(lazyframe: LazyFrame) -> Result<LazyFrame, Box<dyn Error>> {
...
fn condicoes_ncm_04(descricao: &str, _ncm: u64) -> Option<&'static str> {
    ...
    static LEITE_IN_NATURA: Lazy<Regex> = Lazy::new(|| Regex::new(r"(?i)Leite (In Natura|Cru)").unwrap());
